    ...
    <footer className="bg-gray-950 text-gray-300 mt-16" id="footer">
      <div className="max-w-6xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          {/* Brand */}
          <div>
            <Image src="/images/logo/gurugram-it-network-logo.webp" alt="Gurugram IT NETWORKS" width={240} height={60} className="h-12 w-auto mb-6 bg-white p-2 rounded-xl shadow-sm" />
